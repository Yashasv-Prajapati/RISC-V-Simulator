...
def decode():
    ...
    stage3['immFinal'] = getFinalImmediate(
        stage3['inst_type'], imm, immS, immB, immU, immJ)

    ALUop = getALUop(stage3['inst_type'], func3, func7)

    op2selectMUX(stage3['inst_type'], rs1, rs2, stage3['immFinal'])
    BranchTargetSelectMUX(stage3['inst_type'],
                          stage3['immFinal'])  # this is left
    ...
    printOperationDetails(stage3['inst_type'], stage3['immFinal'])
    stage3['rs2'] = rs2
    stage3['rd'] = rd
